...
/**
 * @Description: 考勤补卡审批不同意
 * @author: lvdandan
 * @date: 2020年04月03日 15:07
 */
public class OaSignPatchDisagreeService implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        int count = eoaSignService.updateSignPatchBizStatus(CommonConstant.SIGN_PATCH_BIZ_STATUS_2,id);
        if(count == 0){
